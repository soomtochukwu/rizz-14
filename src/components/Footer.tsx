...
export function Footer() {
    return (
        <footer className="w-full mb-4 bg-red-400 text-center py-2 shrink-0 relative z-10 flex justify-between items-center px-4 md:px-6 pb-2 sm:pb-2 safe-area-bottom">
