export function Footer() {
    return (
        <footer className="w-full text-center py-2 shrink-0 relative z-10 flex gap-3 justify-center">
            <a
                href="/about"
            ...
            <p className="w-full text-[10px] font-mono text-gray-400 hidden md:block">
